...
public abstract class SweetBerryConcentrateFluid extends ForgeFlowingFluid {
    protected SweetBerryConcentrateFluid(Properties properties) {
        super(properties);
    }
    ...
    public static class Source extends SweetBerryConcentrateFluid {
    ...
    public static class Flowing extends SweetBerryConcentrateFluid {
