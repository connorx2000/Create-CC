...
public abstract class ColaSyrupFluid extends ForgeFlowingFluid {
    protected ColaSyrupFluid(Properties properties) {
        super(properties);
    }
    ...
    public static class Source extends ColaSyrupFluid {
    ...
    public static class Flowing extends ColaSyrupFluid {
