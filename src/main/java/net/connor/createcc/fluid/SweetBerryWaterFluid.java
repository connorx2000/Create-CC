...
public abstract class SweetBerryWaterFluid extends ForgeFlowingFluid {
    protected SweetBerryWaterFluid(Properties properties) {
        super(properties);
    }
    ...
    public static class Source extends SweetBerryWaterFluid {
    ...
    public static class Flowing extends SweetBerryWaterFluid {
