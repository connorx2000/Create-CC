...
public abstract class SweetBerryColaFluid extends ForgeFlowingFluid {
    protected SweetBerryColaFluid(Properties properties) {
        super(properties);
    }
    ...
    public static class Source extends SweetBerryColaFluid {
    ...
    public static class Flowing extends SweetBerryColaFluid {
