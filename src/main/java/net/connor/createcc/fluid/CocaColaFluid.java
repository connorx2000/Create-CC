...
public abstract class CocaColaFluid extends ForgeFlowingFluid {
    protected CocaColaFluid(Properties properties) {
        super(properties);
    }
    ...
    public static class Source extends CocaColaFluid {
    ...
    public static class Flowing extends CocaColaFluid {
